...
class Runner(object):
    def __init__(self, train_set, val_set, test_set, model, marginal_prob_std_fn,optimizer, scheduler, config, loss_fn, device, checkpoint):
    ...
    def train(self, verbose=1):
        ...
        for epoch in range(num_epochs):
            ...
            for batch in train_dataloader:
                ...
                loss = loss_fn(model, batch, self.marginal_prob_std_fn)
